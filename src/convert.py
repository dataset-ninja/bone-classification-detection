...
def convert_and_upload_supervisely_project(
    ...
    train_path = "/home/grokhi/rawdata/bone-classification-detection/train"
    val_path = "/home/grokhi/rawdata/bone-classification-detection/valid"
    images_ext = ".png"
    ann_ext = ".txt"
    batch_size = 30

    ds_name_to_data = {"train": train_path, "valid": val_path}
    ...
    idx_to_class = {
        0: sly.ObjClass("wrist", sly.Rectangle),
        1: sly.ObjClass("elbow", sly.Rectangle),
        2: sly.ObjClass("hand", sly.Rectangle),
    }
